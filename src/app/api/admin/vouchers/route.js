...
export async function GET(req) {
    try {
        ...
        return NextResponse.json({ success: true, vouchers: list }, { status: 200 });
    } catch (err) {
...
export async function POST(req) {
    try {
        ...
        const code = normalizeText(body.code || body.voucherCode || "").toUpperCase() || null;
        ...
        return NextResponse.json({ success: true, voucher: payload, message: "Voucher created" }, { status: 200 });
    } catch (err) {
